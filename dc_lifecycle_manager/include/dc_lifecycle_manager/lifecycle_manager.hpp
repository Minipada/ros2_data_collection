...
#ifndef DC_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_HPP_
#define DC_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_HPP_
...
/**
 * @class dc_lifecycle_manager::LifecycleManager
...
public:
  /**
   * @brief A constructor for dc_lifecycle_manager::LifecycleManager
   * @param options Additional options to control creation of the node.
   */
  explicit LifecycleManager(const rclcpp::NodeOptions& options = rclcpp::NodeOptions());
  /**
   * @brief A destructor for dc_lifecycle_manager::LifecycleManager
   */
  ~LifecycleManager();
...
protected:
  ...
  std::uint8_t getTransition(const std::string& transition);
  ...
  // The names of the transition to switch, in the order of desired bring-up
...
#endif  // DC_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_HPP_
