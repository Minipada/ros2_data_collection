...
namespace Model
{
  ...
  public:
    ...
    template<typename BucketT = Aws::String>
    PutObjectLegalHoldRequest& WithBucket(BucketT&& value) { SetBucket(std::forward<BucketT>(value)); return *this;}
    ///@}
    ...
    template<typename KeyT = Aws::String>
    PutObjectLegalHoldRequest& WithKey(KeyT&& value) { SetKey(std::forward<KeyT>(value)); return *this;}
    ///@}
    ...
    template<typename LegalHoldT = ObjectLockLegalHold>
    PutObjectLegalHoldRequest& WithLegalHold(LegalHoldT&& value) { SetLegalHold(std::forward<LegalHoldT>(value)); return *this;}
    ///@}
    ...
    inline PutObjectLegalHoldRequest& WithRequestPayer(RequestPayer value) { SetRequestPayer(value); return *this;}
    ///@}
    ...
    template<typename VersionIdT = Aws::String>
    PutObjectLegalHoldRequest& WithVersionId(VersionIdT&& value) { SetVersionId(std::forward<VersionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ContentMD5T = Aws::String>
    PutObjectLegalHoldRequest& WithContentMD5(ContentMD5T&& value) { SetContentMD5(std::forward<ContentMD5T>(value)); return *this;}
    ///@}
    ...
    inline PutObjectLegalHoldRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) { SetChecksumAlgorithm(value); return *this;}
    ///@}
    ...
    template<typename ExpectedBucketOwnerT = Aws::String>
    PutObjectLegalHoldRequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) { SetExpectedBucketOwner(std::forward<ExpectedBucketOwnerT>(value)); return *this;}
    ///@}
    ...
    template<typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
    PutObjectLegalHoldRequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) { SetCustomizedAccessLogTag(std::forward<CustomizedAccessLogTagT>(value)); return *this;}
