...
| [Fast DDS statistics](./demos/fastdds_stats_pgsql_grafana.md) | Collect Fast DDS's own network statistics and read them back in Grafana. No robot or simulator needed | [PostgreSQL](./infrastructure_setup/postgresql.md) and Grafana running together, plus Fast DDS built with its Statistics Module enabled |
