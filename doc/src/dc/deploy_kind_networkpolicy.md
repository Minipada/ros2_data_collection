...
policy-enforcing CNI — unlike the [k3d dev loop](https://github.com/minipada/ros2_data_collection/tree/lyrical/deploy/robot)'s
...
- `kind` (`v0.33.0`) and `kubectl` (`v1.31.4`) on `PATH` — CI installs these via
  ...
  see [`tools/kind/README.md`](https://github.com/minipada/ros2_data_collection/tree/lyrical/tools/kind)
