...
| Name                                                            | Description                                |
| --------------------------------------------------------------- | ------------------------------------------ |
| [flb_file](./dc/destinations/flb_file.md)                       | JSON in a file via Fluent bit              |
| [flb_http](./dc/destinations/flb_http.md)                       | JSON to http request via Fluent bit        |
| [flb_kinesis_streams](./dc/destinations/flb_kinesis_streams.md) | JSON to AWS Kinesis Streams via Fluent bit |
| [flb_minio](./dc/destinations/flb_minio.md)                     | JSON to Minio via Fluent bit               |
| [flb_pgsql](./dc/destinations/flb_pgsql.md)                     | JSON to PostgreSQL via Fluent bit          |
| [flb_stdout](./dc/destinations/flb_stdout.md)                   | JSON to STDOUT via Fluent bit              |
| [rcl](./dc/destinations/rcl.md)                                 | JSON to RCL                                |
