...
([ADR-0014](./adr/0014-uploader-runs-as-its-own-process.md)) and the blessed `vector`
...
([ADR-0014](./adr/0014-uploader-runs-as-its-own-process.md)) — not by a Vector sink:
