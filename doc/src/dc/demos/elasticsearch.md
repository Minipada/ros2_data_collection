...
```admonish info
The full configuration file can be found [here](https://github.com/Minipada/ros2_data_collection/blob/lyrical/dc_demos/params/elasticsearch.yaml), and the passthrough sink config [here](https://github.com/Minipada/ros2_data_collection/blob/lyrical/dc_demos/config/elasticsearch_sink.toml).
```
